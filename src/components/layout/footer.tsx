...
export const Footer = () => {
    ...
    return (
        <footer className="bg-[#282728] text-[#adadad] border-t-[5px] border-[#c5050c] text-sm">
            {/* Inline <symbol> for UW Crest */}
            <svg style={{ display: 'none' }} xmlns="http://www.w3.org/2000/svg">
                <symbol id="uw-symbol-crest-footer" viewBox="0 0 200 132.78" fill="currentColor">
                    ...
                    />
                    <path
                        d="M37,133.29h-4v-7.14h4v1H34.08v1.94h2.69v1H34.08v2.24H37v1Z"
                        transform="translate(-1 -0.61)"
                    />
                    <path
                    ...
                    <path
                        d="M62.81,129.41l1.69-3.26h1.27l-2.38,4.37v2.77H62.22v-2.73l-2.37-4.41h1.27Z"
                        transform="translate(-1 -0.61)"
                    />
                    <path
                    ...
                    />
                    <path
                        d="M79.36,133.29H78.2v-7.14h4v1H79.36v2.23h2.69v1H79.36v2.93Z"
                        transform="translate(-1 -0.61)"
                    />
                    <path
            ...
            <div className="mx-auto max-w-7xl px-4 py-8 flex flex-wrap justify-around gap-8">
                {/* UW Crest and System Link */}
                <div className="flex flex-col items-center text-center space-y-4">
                    <a
                        href="https://www.wisc.edu"
                        aria-label="University of Wisconsin–Madison"
                        className="text-[#adadad] hover:text-white"
                    >
                        <svg width="200" height="150" aria-hidden="true" role="img">
                            <use xlinkHref="#uw-symbol-crest-footer" />
                        </svg>
                    </a>
                    <a href="https://www.wisconsin.edu/" className="hover:text-white text-[0.9375rem] block mt-2">
                        Part of the <span className="whitespace-nowrap">Universities of Wisconsin</span>
                    </a>
                </div>
                ...
                <div className="text-center md:text-left">
                    <h3 className="uppercase font-semibold text-base mb-4">Contact Us</h3>
                    <ul className="space-y-4">
                        <li>
                        ...
                        <li className="flex items-center space-x-2">
                            <span className="icon-[tabler--map-pin] size-5" />
                            <a
                                href="https://www.google.com/maps/place/1025+W+Johnson+St,+Madison,+WI+53706"
                                target="_blank"
            ...
            {/* Bottom bar */}
            <div className="text-center py-6 border-t border-[#444] px-4">
                <p>
                    Feedback, questions or accessibility issues:{' '}
                    <Link href="mailto:shamya.karumbaiah@wisc.edu" className="underline hover:text-white">
                        shamya.karumbaiah@wisc.edu
                    </Link>
                </p>
                <p>&copy; {year} TRAIL Lab, All Rights Reserved</p>
            </div>
        </footer>
    )
}
